...
BiomeTrees.GetBiomeTreeName = function(surface, position)
    ...
    local tile = surface.get_tile(position--[[@as TilePosition # handled equally by Factorio in this API function.]] ) ---@diagnostic disable-line # Needed in `a-robot-friend` mod but not `muppet-streamer` for some weird reason.
