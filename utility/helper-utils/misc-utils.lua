...
--TODO: write a function that gets a random non already used color and returns it. Must store this data in globals and have it take a "colorPurposeName" so it can be run multiple times concurrently.
